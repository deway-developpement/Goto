...
export class migrations1685207928680 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`performance\` ADD \`duration\` decimal(5,2) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`performance\` DROP COLUMN \`distance\``);
        await queryRunner.query(`ALTER TABLE \`performance\` ADD \`distance\` decimal(5,1) NOT NULL`);
